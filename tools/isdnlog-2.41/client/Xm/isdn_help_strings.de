...
Stefan Lüthje (luethje@@konstanz.netsurf.de) -- CS-Architektur, isdnrep\n\
Bernhard Kruepl (b.kruepl@@ieee.org) -- Gebührenauswertung\n\
...
unzählige Mitglieder der isdn4linux-Mailing-Liste als\n\
Beta-Tester/Ideen-Lieferanten",

/* 1 */ "xisdn Online-Hilfe",
"Die Oberfläche ist in 3 Bereiche unterteilt: Ein Menübar mit Funktionen und Hilfe,\n\
...
der letzten Liste können ausgewählt und dann mit 'Funktionen->Löschen' entfernt\n\
werden. Die Spalten tragen die folgenden Informationen (von links her): Monat,\n\
Tag, Verbindungsanfang, Dauer der Verbindung, Gebühren, Währung, MSN, Richtung,\n\
Gegenstelle, deren Ort, Status. Mit 'Funktionen->Protokoll' können alle Meldungen\n\
